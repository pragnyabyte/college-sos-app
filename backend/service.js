...
export async function deleteIncident(id, u, ip = '') {
  ...
  if (u?.id !== 'RESP-1111' && !['RESPONDER', 'TEACHER', 'INSTITUTE_ADMIN', 'SUPER_ADMIN', 'ADMIN'].includes(uRole)) {
